...
kq_map = [{
  KQ_Support_Wellbeing: "How well do we support people’s wellbeing?",
  KQ_Staff_Team: "How good is our staff team?",
  KQ_Setting: "How good is our setting?",
  KQ_Leadership: "How good is our leadership?",
  KQ_Care_Play_and_Learning: "How good is our care, play and learning?",
  KQ_Care_and_Support_Planning: "How well is our care and support planned?"}]
...
selected_wrangled = aq.from([service_selected]) // Wrap in array because service_selected is one row
  ...
  .ungroup("grade")
  .derive({
    kq_label: (d) => op.recode(d.kq,{ 'KQ_Setting': 'How good is our setting?', 'opt:b': 'B' } , '?')
  })
