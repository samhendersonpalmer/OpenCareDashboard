...
datastore_filtered = filtered_df()
```
...
`{ojs} datastore_filtered.CareService`
...
`{ojs} datastore_filtered.MinGrade`
...
`{ojs} datastore_filtered.months_since_inspection`
...
`{ojs} datastore_filtered.staff_per_place`
...
`{ojs} datastore_filtered.Complaints_upheld_2425`
...
`{ojs} datastore_filtered.any_requirements_2425`
...
`{ojs} datastore_filtered.service`
